                        ...
                        <v-col cols="12">
                            ...
                            <v-table class="table">
                                <tr>
                                    ...
                                    <th class="pa-1 text-black bg-grey border" style="width: 10%;">รายละเอียด</th>
                                    <th class="pa-1 text-black bg-grey border" style="width: 10%;">ไฟล์ที่แนบ</th>
                                ...
                                <tr v-for="indicate in topic.indicates" :key="indicate.id_indicate">
                                    ...
                                    <td class="border pa-1 text-center" style="width: 10%;"><v-btn v-if="indicate.file_eva" color="blue" size="small" @click="viweFile(indicate.file_eva)">ดูไฟล์</v-btn><span v-else>-</span></td>
